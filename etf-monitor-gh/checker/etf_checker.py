...
Läuft stündlich, schreibt dashboard/dashboard.json ins Repo,
...
OUTPUT_FILE = Path("dashboard/dashboard.json")
STATE_FILE  = Path("dashboard/state.json")

ETFS = [
    {"name": "MSCI World",            "ticker": "SPPW.DE", "isin": "IE00BFY0GT14"},
    {"name": "MSCI Emerging Markets", "ticker": "IS3N.DE",  "isin": "IE00B4L5YC18"},
]

YAHOO_URL = "https://query1.finance.yahoo.com/v8/finance/chart/{ticker}?interval=1d&range=60d"
HEADERS   = {
